...
//*
//MVSENDEC EXEC PDPCMP,MEMBER=MVSENDEC,LPARM=''
//LKED.SYSLMOD  DD DSN=PDPCLIB.LINKLIB(MVSENDEC),DISP=SHR
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
...
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
//MVSUNZIP EXEC PDPCMP,MEMBER=MVSUNZIP,LPARM=''
//LKED.SYSLMOD  DD DSN=PDPCLIB.LINKLIB(MVSUNZIP),DISP=SHR
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
//COPYFILE EXEC PDPCMP,MEMBER=COPYFILE,LPARM=''
//LKED.SYSLMOD  DD DSN=PDPCLIB.LINKLIB(COPYFILE),DISP=SHR
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
//DSSRENAM EXEC PDPCMP,MEMBER=DSSRENAM,LPARM=''
//LKED.SYSLMOD  DD DSN=PDPCLIB.LINKLIB(DSSRENAM),DISP=SHR
//LKED.SYSLIB   DD DSN=PDPCLIB.NCALIB,DISP=SHR
//*
//
